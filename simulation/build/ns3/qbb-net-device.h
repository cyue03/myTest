...
CustomHeader CnpHeader(Ptr<Packet> p,CustomHeader &ch);
...
public:
  ...
  typedef Callback<Ptr<Packet>, CustomHeader &> MyCnp;
	MyCnp m_gencnp;

typedef Callback<uint32_t> GetMode;
	GetMode m_ccmode;
